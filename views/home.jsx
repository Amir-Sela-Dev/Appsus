...
export function Home() {
    ...
    return <section className="home">
        ...
        <div className="home-hero"> <div className="home-row1">  <h1>The app that help you orgenize your life.</h1> <div className="google-assistent"><img src="/assets/img/google-assistant.svg" alt="" /></div></div>
